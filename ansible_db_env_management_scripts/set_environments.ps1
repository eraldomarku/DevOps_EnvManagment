...
$logical_to_physical_names=Invoke-AzVMRunCommand -ResourceGroupName apsiaem01 -VMName deve4f2cbff76-1 -CommandId RunPowerShellScript -ScriptString 'Invoke-SqlCmd -Query "SELECT name, physical_name FROM AxDB.sys.database_files"'
